...
/** @type {function(...*):?} */
var _emscripten_bind_Router_hyperedgeRerouter_0 = Module["_emscripten_bind_Router_hyperedgeRerouter_0"] = createExportWrapper("emscripten_bind_Router_hyperedgeRerouter_0");
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_ConnEndListBuilder_0 = Module["_emscripten_bind_ConnEndListBuilder_ConnEndListBuilder_0"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_ConnEndListBuilder_0");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_addConnEnd_1 = Module["_emscripten_bind_ConnEndListBuilder_addConnEnd_1"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_addConnEnd_1");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_addShapePin_2 = Module["_emscripten_bind_ConnEndListBuilder_addShapePin_2"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_addShapePin_2");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_addPoint_1 = Module["_emscripten_bind_ConnEndListBuilder_addPoint_1"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_addPoint_1");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_addPoint_2 = Module["_emscripten_bind_ConnEndListBuilder_addPoint_2"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_addPoint_2");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_addJunction_1 = Module["_emscripten_bind_ConnEndListBuilder_addJunction_1"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_addJunction_1");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_clear_0 = Module["_emscripten_bind_ConnEndListBuilder_clear_0"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_clear_0");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_size_0 = Module["_emscripten_bind_ConnEndListBuilder_size_0"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_size_0");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder_registerHyperedge_1 = Module["_emscripten_bind_ConnEndListBuilder_registerHyperedge_1"] = createExportWrapper("emscripten_bind_ConnEndListBuilder_registerHyperedge_1");
/** @type {function(...*):?} */
var _emscripten_bind_ConnEndListBuilder___destroy___0 = Module["_emscripten_bind_ConnEndListBuilder___destroy___0"] = createExportWrapper("emscripten_bind_ConnEndListBuilder___destroy___0");
/** @type {function(...*):?} */
 ...
 */
Router.prototype['hyperedgeRerouter'] = Router.prototype.hyperedgeRerouter = function() {
  var self = this.ptr;
 ...
 * @class
 */
function ConnEndListBuilder() {
  this.ptr = _emscripten_bind_ConnEndListBuilder_ConnEndListBuilder_0();
  getCache(ConnEndListBuilder)[this.ptr] = this;
};;
ConnEndListBuilder.prototype = Object.create(WrapperObject.prototype);
ConnEndListBuilder.prototype.constructor = ConnEndListBuilder;
ConnEndListBuilder.prototype.__class__ = ConnEndListBuilder;
ConnEndListBuilder.__cache__ = {};
Module['ConnEndListBuilder'] = ConnEndListBuilder;

/**
 * @method
 * @param {ConnEnd} connEnd
 */
ConnEndListBuilder.prototype['addConnEnd'] = ConnEndListBuilder.prototype.addConnEnd = function(connEnd) {
  var self = this.ptr;
  if (connEnd && typeof connEnd === 'object') connEnd = connEnd.ptr;
  _emscripten_bind_ConnEndListBuilder_addConnEnd_1(self, connEnd);
};;

/**
 * @method
 * @param {ShapeRef} shape
 * @param {number} pinClassId
 */
ConnEndListBuilder.prototype['addShapePin'] = ConnEndListBuilder.prototype.addShapePin = function(shape, pinClassId) {
  var self = this.ptr;
  if (shape && typeof shape === 'object') shape = shape.ptr;
  if (pinClassId && typeof pinClassId === 'object') pinClassId = pinClassId.ptr;
  _emscripten_bind_ConnEndListBuilder_addShapePin_2(self, shape, pinClassId);
};;

/**
 * @method
 * @param {Point} point
 * @param {number} visDirs
 */
ConnEndListBuilder.prototype['addPoint'] = ConnEndListBuilder.prototype.addPoint = function(point, visDirs) {
  var self = this.ptr;
  if (point && typeof point === 'object') point = point.ptr;
  if (visDirs && typeof visDirs === 'object') visDirs = visDirs.ptr;
  if (visDirs === undefined) { _emscripten_bind_ConnEndListBuilder_addPoint_1(self, point);  return }
  _emscripten_bind_ConnEndListBuilder_addPoint_2(self, point, visDirs);
};;
 ...
 * @param {JunctionRef} junction
 */
ConnEndListBuilder.prototype['addJunction'] = ConnEndListBuilder.prototype.addJunction = function(junction) {
  var self = this.ptr;
  if (junction && typeof junction === 'object') junction = junction.ptr;
  _emscripten_bind_ConnEndListBuilder_addJunction_1(self, junction);
};;
 ...
 * 
 */
ConnEndListBuilder.prototype['clear'] = ConnEndListBuilder.prototype.clear = function() {
  var self = this.ptr;
  _emscripten_bind_ConnEndListBuilder_clear_0(self);
};;
 ...
 * @returns {number}
 */
ConnEndListBuilder.prototype['size'] = ConnEndListBuilder.prototype.size = function() {
  var self = this.ptr;
  return _emscripten_bind_ConnEndListBuilder_size_0(self);
};;

/**
 * @method
 * @param {HyperedgeRerouter} rerouter
 * @returns {number}
 */
ConnEndListBuilder.prototype['registerHyperedge'] = ConnEndListBuilder.prototype.registerHyperedge = function(rerouter) {
  var self = this.ptr;
  if (rerouter && typeof rerouter === 'object') rerouter = rerouter.ptr;
  return _emscripten_bind_ConnEndListBuilder_registerHyperedge_1(self, rerouter);
};;

  ConnEndListBuilder.prototype['__destroy__'] = ConnEndListBuilder.prototype.__destroy__ = function() {
  var self = this.ptr;
  _emscripten_bind_ConnEndListBuilder___destroy___0(self);
};
(function() {
  function setupEnums() {
